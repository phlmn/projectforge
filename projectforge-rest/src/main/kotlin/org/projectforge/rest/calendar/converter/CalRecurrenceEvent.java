 ...
 *
 */
public class CalRecurrenceEvent implements ICalendarEvent, Serializable
{
  private static final long serialVersionUID = -7523583666714303142L;

  private final CalEvent master;
   ...
   */
  public CalRecurrenceEvent(final CalEvent master, final Calendar startDate)
  {
    this.master = master;
